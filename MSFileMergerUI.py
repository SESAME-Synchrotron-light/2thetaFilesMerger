...
class fileMergerUI(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "SED | 2theta file merger (version 0.3)"))
                        ...
                        if not ignoreLine.startswith('#'): 
                            if not self.isLineEmpty(line):
                                ...
                                try: 
                                    ...
                                    UIMessage("Input file error", "ERROR reading one or more of the selected files", "please make "\
                                        "sure the selected files do not include an"\
                                        " already merged file or simply a file that was not generated by MS beamline at SESAME"\
                                        ". However, the program will try to ingnore this problem").showCritical()
